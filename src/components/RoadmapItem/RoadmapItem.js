...
const RoadmapItem = ({ roadmapTitle, completedTasks,totalTasks, timeSpent, commitsQuantity }) => {
  return (
          ...
          <View style={styles.stats}>
            ...
            <View style={styles.statLine1}>
              <View style={styles.icon}>
                ...
                <Text style={styles.textTypo}>{completedTasks}/{totalTasks}</Text>
              </View>
            ...
            <View style={styles.statLine1}>
              ...
              <Text style={[styles.text2, styles.textTypo]}>{commitsQuantity}</Text>
            </View>
          </View>
